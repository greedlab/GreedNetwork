#
#  Be sure to run `pod spec lint GreedNetwork.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Bell"
  # s.authors            = { "Bell" => "bell@greedlab.com" }
  # s.social_media_url   = "http://twitter.com/Bell"
  ...
  # s.public_header_files = "GreedNetwork/*.h"
